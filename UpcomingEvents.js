...
function createCards(arreglo) {
    ...
    for (let i = 0; i < data.events.length; i++) {
        ...
        if (data.currentDate < data.events[i].date) {
            ...
            nombre.textContent = data.events[i].name
            let content = document.createElement('p');
            description.appendChild(content);
            content.className = 'card-text'
            content.textContent = data.events[i].description
            ...
            price.textContent = 'Price: $' + data.events[i].price
            let info = document.createElement('a');
            details.appendChild(info);
            info.className = 'btn btn-info'
            info.href = 'http://127.0.0.1:5500/Details.html'
